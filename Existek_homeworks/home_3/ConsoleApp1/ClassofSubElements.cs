...
namespace ConsoleApp1
{
    public abstract class Storage_media
    {
        ...
        int __count;
        decimal __price;
        public Storage_media(string t, string g, string m, int c, decimal p)
        {
            __title = t;
            __generator = g;
            __model = m;
    ...
    public class Flash: Storage_media
    {
        decimal capacity;
        decimal speed;
        public Flash(string t, string g, string m, int c, decimal p, decimal cap, decimal s)
            :base(t, g, m, c, p)
        {
            capacity = cap;
            speed = s;
    ...
    public class DVD : Storage_media
    {
        decimal capacity;
        decimal speed;
        public DVD(string t, string g, string m, int c, decimal p, decimal cap, decimal s)
            : base(t, g, m, c, p)
        {
            capacity = cap;
            speed = s;
    ...
    public class HDD : Storage_media
    {
        decimal reading;
        decimal writing;
        public HDD(string t, string g, string m, int c, decimal p, decimal r, decimal w)
            : base(t, g, m, c, p)
        {
            reading = r;
            writing = w;
